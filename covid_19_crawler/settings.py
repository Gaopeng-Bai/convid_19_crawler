...
# Scrapy settings for covid_19_crawler project
#
...
BOT_NAME = 'covid_19_crawler'

SPIDER_MODULES = ['covid_19_crawler.spiders']
NEWSPIDER_MODULE = 'covid_19_crawler.spiders'
...
# SPIDER_MIDDLEWARES = {
#    'covid_19_crawler.middlewares.Convid19SpiderMiddleware': 543,
# }
...
ITEM_PIPELINES = {
   'covid_19_crawler.pipelines.Covid19Pipeline': 300,
}
